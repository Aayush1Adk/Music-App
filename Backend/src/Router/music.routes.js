...
router.delete("/:musicId/dislike", authMiddleware.authUser, musicController.unLikeMusic);
...
router.post("/:musicId/play", authMiddleware.authUser, musicController.playcount);
